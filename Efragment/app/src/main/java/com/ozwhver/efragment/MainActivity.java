...
public class MainActivity extends AppCompatActivity implements TopSessionFragment.TopSectionListener {
    ...
    //this gets called by the first fragment, when the user click the button
    @Override
